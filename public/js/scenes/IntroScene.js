...
export class IntroScene extends Phaser.Scene {
    ...
    create() {
        intro1 = this.add.image(0, 0, constants.IMAGES.INTRO1).setScale(0.45).setOrigin(0);
        intro2 = this.add.image(0, 0, constants.IMAGES.INTRO2).setScale(0.35).setOrigin(0).setVisible(false);
        intro3 = this.add.image(0, 0, constants.IMAGES.INTRO3).setScale(0.45).setOrigin(0).setVisible(false);
