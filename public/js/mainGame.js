...
import {TrainingsimulatorScene} from './scenes/TrainingsimulatorScene.js';


let game = new Phaser.Game({
    width: 800,
    height: 600,
    scene: [LoadScene, MenuScene, Base, TraningScene, ChemistLevel, Timeline, TimeMachineScene, TrainingsimulatorScene], 
    physics: {
        default: 'arcade',
        arcade: {
           // debug: true,
